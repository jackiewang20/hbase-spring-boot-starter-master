package com.example.hbase.stater.component;//package com.example.hbase.stater.component;
//
...
//
///**
// * Hbase 1.4.x api操作工具类。
// *
// * @author jackie
// * @since 2021/2/1 17:31
// */
//public class HBaseServiceWith1x {
...
//
//    public HBaseServiceWith1x(Configuration conf) {
//
//        this.conf = conf;
//        try {
...
//
//            List<HColumnDescriptor> familyDescriptors = new ArrayList<>(columnFamily.size());
//
//            columnFamily.forEach(cf -> {
//                familyDescriptors.add(new HColumnDescriptor(cf));
//            });
//
//            HTableDescriptor tableDescriptor = new HTableDescriptor(tableName);
//            for (HColumnDescriptor familyDescriptor : familyDescriptors) {
...
//     *
//     * @param tableName 表名；
//     * @param prefix    以prefix开始的rowkey(行键)；
//     * @return java.util.Map<java.lang.String, java.util.Map < java.lang.String, java.lang.String>>
//     */
//    public Map<String, Map<String, String>> getResultScannerRowkeyPrefixFilter(String tableName, String prefix) {
//        Scan scan = new Scan();
//
...
//        } catch (Exception e) {
//            log.error(MessageFormat.format("为表添加或更新数据失败,tableName:{0},rowKey:{1},familyName:{2}"
...
//                log.debug(MessageFormat.format("column({0}) is deleted!", columnName));
//            }
//        } catch (IOException e) {
//            log.error(MessageFormat.format("删除指定的列失败,tableName:{0},columnName:{1}"
